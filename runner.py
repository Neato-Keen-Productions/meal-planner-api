...
def main(sdk_path, test_paths, test_pattern):
    ...
    for test_path in test_paths:
        ...
        tests += suite._tests;
    return unittest.TextTestRunner(verbosity=2).run(unittest.loader.TestLoader().suiteClass(tests))
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--test-pattern',
        help='The file pattern for test modules is *_test.py.',
        default='*_test.py')

    args = parser.parse_args()

    result = main(args.sdk_path, args.test_path.split(","), args.test_pattern)
